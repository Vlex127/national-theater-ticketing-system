...
export default function NavLinks({ setIsMenuOpen }: NavLinksProps) {
  return (
    <>
      <a 
        className="text-gray-300 hover:text-amber-400 transition-colors duration-200 text-base font-medium py-3 flex items-center gap-2" 
        href="/" 
