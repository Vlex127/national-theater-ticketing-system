...
export default function Home() {
  ...
  const NavLinks = () => (
    <>
      <a className="text-gray-300 hover:text-amber-400 transition-colors duration-200 text-base font-medium py-2 flex items-center gap-2" href="/">
            ...
            <div className="flex items-center justify-between h-16 lg:h-20">
              ...
              <div className="flex items-center gap-3">
                <div className={`size-10 flex items-center justify-center rounded-full ${ACCENT_BG} shadow-lg`}>
                  <span className="material-icons text-gray-900 font-bold text-xl">
                    theater_comedy
                  </span>
                </div>
                <div>
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="max-w-4xl mx-auto">
              <div className="inline-flex items-center gap-2 bg-amber-500/20 backdrop-blur-sm rounded-full px-4 py-2 mb-8 border border-amber-500/30">
                ...
                <span className="text-amber-400 text-sm font-semibold uppercase tracking-wider flex items-center gap-1">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-black mb-4 flex items-center justify-center gap-3">
                <span className="material-icons text-amber-500 text-4xl">event_available</span>
              ...
              {events.map((event, index) => (
                ...
                >
                  <div className="relative overflow-hidden">
                    ...
                    />
                    <div className="absolute top-4 right-4 bg-amber-500 text-gray-900 font-bold px-3 py-1 rounded-full text-sm flex items-center gap-1">
                      <span className="material-icons text-sm">schedule</span>
                      {event.date}
                    </div>
                    <div className="absolute top-4 left-4 bg-gray-900/80 text-white px-2 py-1 rounded-full text-xs flex items-center gap-1">
                  ...
                  <div className="p-6">
                    ...
                    <button className="w-full bg-gray-700 hover:bg-amber-500 hover:text-gray-900 text-white font-semibold py-3 rounded-lg transition-all duration-300 group-hover:transform group-hover:scale-105 flex items-center justify-center gap-2">
                      <span className="material-icons text-lg">confirmation_number</span>
                      Get Tickets
                    </button>
                  </div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className="text-4xl md:text-5xl font-black mb-6 flex items-center gap-3">
                  <span className="material-icons text-amber-500 text-4xl">history_edu</span>
                  A Legacy of <span className={ACCENT_COLOR}>Cultural Excellence</span>
                </h2>
                <div className="space-y-4 text-gray-300 text-lg leading-relaxed">
                  <p className="flex items-start gap-2">
                    <span className="material-icons text-amber-400 text-lg mt-1">architecture</span>
                  ...
                  <p className="flex items-start gap-2">
                    <span className="material-icons text-amber-400 text-lg mt-1">celebration</span>
                  ...
                  <p className="flex items-start gap-2">
                    <span className="material-icons text-amber-400 text-lg mt-1">diversity</span>
                ...
                <div className="flex flex-wrap gap-4 mt-8">
                  <div className="text-center p-4 bg-gray-800 rounded-xl flex-1 min-w-[120px]">
        ...
        <section className="py-16 bg-gradient-to-r from-amber-500/10 to-amber-600/10">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="flex justify-center mb-6">
              <span className="material-icons text-amber-500 text-4xl">mail</span>
            </div>
            <h3 className="text-3xl font-black mb-4">Stay in the Spotlight</h3>
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <input
                ...
                className="flex-1 bg-gray-800 border border-gray-700 rounded-full px-6 py-3 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-amber-500"
              />
              <button className="bg-amber-500 hover:bg-amber-600 text-gray-900 font-semibold px-8 py-3 rounded-full transition-all duration-300 flex items-center gap-2 justify-center">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="grid md:grid-cols-4 gap-8">
              <div className="md:col-span-2">
                <div className="flex items-center gap-3 mb-4">
                  <div className={`size-10 flex items-center justify-center rounded-full ${ACCENT_BG}`}>
                    <span className="material-icons text-gray-900 font-bold">
                      theater_comedy
                    </span>
                  </div>
                  <div>
              ...
              <div>
                <h4 className="text-white font-semibold mb-4 flex items-center gap-2">
                  <span className="material-icons text-amber-400">link</span>
                  Quick Links
                </h4>
                <div className="space-y-2">
                  <a href="#" className="block text-gray-400 hover:text-amber-400 transition-colors flex items-center gap-2">
              ...
              <div>
                <h4 className="text-white font-semibold mb-4 flex items-center gap-2">
                  <span className="material-icons text-amber-400">contact_page</span>
                  Contact
                </h4>
            ...
            <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex items-center gap-6 mt-4 md:mt-0">
                <a className="text-gray-400 hover:text-amber-400 transition-colors text-sm flex items-center gap-1" href="#">
